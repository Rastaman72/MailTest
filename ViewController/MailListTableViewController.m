...
- (IBAction)getPush:(id)sender
{
    ...
    else
    {
        ...
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"Error" message:@"You are offline" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [alert show];
    }
}

#pragma mark- Connection test
- (BOOL)connected {
...
-(void)getData
{
    static NSString * const BaseURLString = @"http://jack.spot.pl/testapi.php";
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        self.temp = (NSDictionary *)responseObject;
